 ...
 *
 */
public class YfCommUtils implements YfQueryIFOld, YfQueryIFOld2
{
	...
	{	
		...
		String 		sQueryId 	= getStackColInfoWithPk;
...
//	}
	...
	public String getCarMoveYN(String cardNo)
	{
		...
		if
		(
			(cardNo.equals(YfConstant.CAR_BAY_TRANS_CARD_NO_6)) || 
			(cardNo.equals(YfConstant.CAR_BAY_TRANS_CARD_NO_7)) || 
			(cardNo.equals(YfConstant.CAR_BAY_TRANS_CARD_NO_8)) || 
			(cardNo.equals(YfConstant.CAR_BAY_TRANS_CARD_NO_9)) || 
			(cardNo.equals(YfConstant.CAR_BAY_TRANS_CARD_NO_0))
		) 
		{
			carMove = "Y"; 
		}
