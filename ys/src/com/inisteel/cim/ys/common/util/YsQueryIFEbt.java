...
public interface YsQueryIFEbt {
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getMvStkWrkBookMtlPp
	-- 작업예약등록 이적재료조회
	 ...
	 * </pre>
	 */
	public final static String getMvStkWrkBookMtlPp = "com.inisteel.cim.ys.ebt.dao.getMvStkWrkBookMtlPp";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getStatSchCd
	-- 스케줄코드상태조회
	...
	SELECT SR.YD_SCH_CD
	  ...
	  FROM (
	            ...
	            SELECT A.YD_GP
	                  ,A.YD_BAY_GP
	                  ,A.YD_SCH_CD
	                  ,CASE WHEN B.STAT1 = 'O' AND B.STAT2 = 'O' AND A.YD_CRN_PRIOR1 <= A.YD_CRN_PRIOR2 THEN A.YD_CRN1  -- 'O':정상, 'C':고장, 'X':NULL
	 ...
	 * </pre>
	 */
	public final static String getStatSchCd = "com.inisteel.cim.ys.ebt.dao.getStatSchCd";


	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.insWrkBook
	-- 작업예약 등록
	 ...
	 * </pre>
	 */
	public final static String insWrkBook_ebt = "com.inisteel.cim.ys.ebt.dao.insWrkBook";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.insWrkBookMtl
	-- 작업예약재료 등록
	 ...
	 * </pre>
	 */
	public final static String insWrkBookMtl_ebt = "com.inisteel.cim.ys.ebt.dao.insWrkBookMtl";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getStatEqp
	-- 설비상태조회 
	 ...
	 * </pre>
	 */
	public final static String getStatEqp = "com.inisteel.cim.ys.ebt.dao.getStatEqp";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getCrnSchWbook
	-- (작업예약ID) 작업예약ID 조회
	 ...
	 * </pre>
	 */
	public final static String getCrnSchWbook = "com.inisteel.cim.ys.ebt.dao.getCrnSchWbook";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getCrnSchWbookSchcd
	-- (스케줄코드) 작업예약ID 조회
	 ...
	 * </pre>
	 */
	public final static String getCrnSchWbookSchcd = "com.inisteel.cim.ys.ebt.dao.getCrnSchWbookSchcd";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getCrnSchWbookEqp
	-- (설비코드) 작업예약ID 조회
	                    ...
	                    SELECT YD_SCH_CD
	                      ...
	                      FROM (
	                                ...
	                                SELECT YD_SCH_CD
	                                  ...
	                                  FROM TB_YS_SCHRULE                        -- YS_특수강스케줄기준
	                                 WHERE YD_GP      = 'G'                     -- 특수강-야드: 'G'
	                                   AND YD_BAY_GP  = 'E'                     -- 특수강-동  : 'E'
	                                   AND SUBSTR(YD_SCH_CD,8,1) IN ('A', 'B')  -- 특수강-스판: 대형옥내('A'), 빌렛정정('B')
	                                   AND YD_DATA_GP = 'M'                     -- DATA구분: R(Register), M(Modify)
	                           )
	               ) SR
	              ,TB_YS_WRKBOOK WB
	 ...
	 * </pre>
	 */
	public final static String getCrnSchWbookEqp = "com.inisteel.cim.ys.ebt.dao.getCrnSchWbookEqp";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.updWmStrLoc
	...
	--                             AND ((WB.YD_SCH_CD LIKE 'K_PC%' AND SL.YS_STK_COL_GP LIKE 'K_PC%') OR (WB.YD_SCH_CD NOT LIKE 'K_PC%' AND 1=1))
	 ...
	 * </pre>
	 */
	public final static String updWmStrLoc = "com.inisteel.cim.ys.ebt.dao.updWmStrLoc";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getCrnSchStat
	...
	SELECT WB.YD_GP                                                --야드구분
	      ...
	      ,(SELECT YD_EQP_WRK_MODE 
	         ...
	         WHERE YD_GP     = 'G'
	           AND YD_BAY_GP = 'F'
	           AND YD_EQP_ID = WB.YD_WRK_PLAN_CRN
	           AND DEL_YN    = 'N') AS YD_EQP_WRK_MODE_PLN         --작업계획크레인 야드설비작업MODE
	      ...
	      ,(SELECT MIN(CASE WHEN SL.YS_STK_COL_GP||SL.YS_STK_BED_NO||SL.YS_STK_LYR_NO = CS.YS_DN_WO_LOC||YS_DN_WO_LAYER                                THEN '1'
	         ...
	         WHERE WM.SSTL_NO     = SL.SSTL_NO
	           ...
	           AND (SUBSTR(SL.YS_STK_COL_GP,3,2) NOT IN ('RP','BS') OR (SUBSTR(SL.YS_STK_COL_GP,3,2) = 'TR' AND WB.YD_SCH_CD NOT LIKE '__TR__U_'))  -- 작업중복(적치/권상/권하)이 가능한 보급대or차량상차 시 CHECK 안함 => 보급/추출대[RP/BS/TR]
	           AND WM.YD_WBOOK_ID = WB.YD_WBOOK_ID
	           AND WM.DEL_YN      = 'N'
	           AND SL.DEL_YN      = 'N'
	 ...
	 * </pre>
	 */
	public final static String getCrnSchStat = "com.inisteel.cim.ys.ebt.dao.getCrnSchStat";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getWorkBookColGpBedGroupTr
	 ...
	 * </pre>
	 */
	public final static String getWorkBookColGpBedGroupTr = "com.inisteel.cim.ys.ebt.dao.getWorkBookColGpBedGroupTr";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getStkLyrbyWBookIdGroupTr
	...
	--봉강의 "산적Lot번호"가 어디에 있는지 모르고, 대형옥내 최적TO위치검색 조건에 포함되지 않아 제외 가능할 듯...
	-- SELECT "산적LOT번호"???  FROM USRPBA.TB_PB_BUNDLECOMM AA WHERE AA.BNDL_NO = X.SSTL_NO AND ITEMNAME_CD = 'SRR'
	 ...
	 * </pre>
	 */
	public final static String getStkLyrbyWBookIdGroupTr = "com.inisteel.cim.ys.ebt.dao.getStkLyrbyWBookIdGroupTr";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getWorkBookColGpGroup
	 ...
	 * </pre>
	 */
	public final static String getWorkBookColGpGroup = "com.inisteel.cim.ys.ebt.dao.getWorkBookColGpGroup";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getStkLyrbyWBookIdGroupV1
	 ...
	 * </pre>
	 */
	public final static String getStkLyrbyWBookIdGroupV1 = "com.inisteel.cim.ys.ebt.dao.getStkLyrbyWBookIdGroupV1";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getYdStklyrSstl
	-- 크레인스케줄(권상위치) 재료정보 조회
	 ...
	 * </pre>
	 */
	public final static String getYdStklyrSstl = "com.inisteel.cim.ys.ebt.dao.getYdStklyrSstl";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.insYdCrnsch
	-- 크레인스케줄 등록
	 ...
	 * </pre>
	 */
	public final static String insYdCrnsch = "com.inisteel.cim.ys.ebt.dao.insYdCrnsch";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.updYdStkLyrMtlStat
	 ...
	 * </pre>
	 */
	public final static String updYdStkLyrMtlStat = "com.inisteel.cim.ys.ebt.dao.updYdStkLyrMtlStat";

	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.insYdCrnwrkmtl
	-- 크레인스케줄 작업재료 등록
	 ...
	 * </pre>
	 */
	public final static String insYdCrnwrkmtl = "com.inisteel.cim.ys.ebt.dao.insYdCrnwrkmtl";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getYdWrkbook
	-- 작업예약 조회
	 ...
	 * </pre>
	 */
	public final static String getYdWrkbook = "com.inisteel.cim.ys.ebt.dao.getYdWrkbook";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getYdCrnschByEqpIdandWBookId
	-- 크레인스케줄 조회
	...
	--    ,(CASE WHEN B.YD_TO_LOC_GUIDE LIKE 'C_TY%' THEN (SELECT YD_TO_LOC_GUIDE FROM TB_YS_WRKBOOK C WHERE C.YD_WBOOK_ID = B.YD_WBOOK_ID)
	--           ELSE B.YD_TO_LOC_GUIDE END) AS YD_TO_LOC_GUIDE
	...
	--    ,(SELECT ITEM FROM TB_YS_RULE WHERE REPR_CD_GP = 'BAWB01')                                    AS DIRECT_GP   -- 블름 직상차 구분: 1:일반, 2:차량우선, 3:대차우선
	--      ,CASE WHEN B.YD_SCH_CD LIKE 'C_TF01LM%' AND SUBSTR(NVL(B.YS_DN_WO_LOC,'0000'),3,2) IN ('03','06') THEN ( SELECT YD_EQP_ID
	--                                                                                                                 FROM TB_YS_EQP
	--                                                                                                                WHERE YD_EQP_STAT<>'B'
	--                                                                                                                  AND YD_EQP_ID = ( SELECT SUBSTR(B.YD_SCH_CD,0,2)||'CR'||SUBSTR(B.YD_SCH_CD,2,1)||ITEM 
	--                                                                                                                                      FROM TB_YS_RULE 
	--                                                                                                                                     WHERE REPR_CD_GP = SUBSTR(B.YD_SCH_CD,0,2)||'TF01' ) )
	--            ELSE ( SELECT MIN(C.YS_STR_LOC)
	...
	--                      AND (
	--                            (REPLACE(C.YD_EQP_GP,'TF','TY') = SUBSTR((CASE WHEN NVL(B.YS_DN_WO_LOC,'0000') LIKE 'C_TY02%' THEN '0000' ELSE NVL(B.YS_DN_WO_LOC,'0000') END),3,2)
	--                             AND SUBSTR(C.YS_STR_LOC,1,2)   = SUBSTR(NVL(B.YS_DN_WO_LOC,'00'),1,2))
	--                            OR 
	--                            (REPLACE(C.YD_EQP_GP,'TF','TY') = SUBSTR((CASE WHEN NVL(B.YS_UP_WO_LOC,'0000') LIKE 'C_TY02%' THEN '0000' ELSE NVL(B.YS_UP_WO_LOC,'0000') END),3,2) 
	--                             AND SUBSTR(C.YS_STR_LOC,1,2)   = SUBSTR(NVL(B.YS_UP_WO_LOC,'00'),1,2))
	--                          )
	--                    )
	--        END AS YD_EQP_ID_NEW 
	 ...
	 * </pre>
	 */
	public final static String getYdCrnschByEqpIdandWBookId = "com.inisteel.cim.ys.ebt.dao.getYdCrnschByEqpIdandWBookId";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getYdCrnwrkmtlBySchId
	-- 크레인스케줄 작업재료 조회
	 ...
	 * </pre>
	 */
	public final static String getYdCrnwrkmtlBySchId = "com.inisteel.cim.ys.ebt.dao.getYdCrnwrkmtlBySchId";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.common.dao.YsCommDAO.getCrnWrkMgtSCSch_Car
	 ...
	 * </pre>
	 */
	public final static String getCrnWrkMgtSCSch_Car = "com.inisteel.cim.ys.common.dao.YsCommDAO.getCrnWrkMgtSCSch_Car";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getYdStock
	-- 저장품정보 조회
	...
	--   , (SELECT BLOOM_STACK_LOT_NO  FROM USRPBA.TB_PB_BLOOMCOMM A WHERE A.BLM_NO=B.SSTL_NO
	--      UNION ALL
	--      SELECT BILLET_STACK_LOT_NO FROM USRPBA.TB_PB_BILLETCOMM A WHERE A.BLT_NO=B.SSTL_NO
	--     ) AS YD_STK_LOT_CD       --야드산적LOT코드
	 ...
	 * </pre>
	 */
	public final static String getYdStock = "com.inisteel.cim.ys.ebt.dao.getYdStock";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getYdStklyrSTLNO
	-- 적재위치정보 조회
	 ...
	 * </pre>
	 */
	public final static String getYdStklyrSTLNO = "com.inisteel.cim.ys.ebt.dao.getYdStklyrSTLNO";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getToLocCol
	...
	WITH PARAM AS (
	    SELECT :V_YD_TO_LOC_DCSN_MTD AS V_YD_TO_LOC_DCSN_MTD  --TO위치결정방법: [M:주작업이적][W:보조작업이적]
	         ...
	         , :V_STLKND             AS V_STLKND              --재료구분: [RR:봉강], [QT:각강/빌렛]
	         , :V_ITEMNAME_CD        AS V_ITEMNAME_CD         --품명코드: [봉강:SRR][각강:SRQ][빌렛:SRI,SRW]
				      ...
				      FROM (
				                SELECT B.YS_STK_COL_GP  AS M_TO_LOC_ZONE
				                 ...
				                 WHERE A.YD_LOC_SRCH_RNG_REG_SNO = B.YD_LOC_SRCH_RNG_REG_SNO
				                   ...
				                   AND A.YS_ROUTE_GP   = (CASE WHEN P.V_YD_SCH_CD IN ('GFTR01LM') THEN P.V_STLKND
				                                               ELSE A.YD_STR_GTR_CD END)  --강종: [RR:SRR][QT:SRQ/SRI,SRW]
				           )
	            ...
	            SELECT F.SEQ_NUM
	              ...
	              FROM (    --적치 가능한 "열"(+"Max-BED/Max-단")
	                 ...
	                 , (
	                     SELECT *
	                       FROM (
	                                 -- 동일한 사양의 "열" : 길이 > 두께(각) > Heat No > 강종
	                                 SELECT A1.YS_STK_COL_GP
	                                      , MAX( CASE WHEN B1.YD_MTL_L = C1.V_YD_MTL_L AND B1.YD_MTL_T = C1.V_YD_MTL_T AND B1.HEAT_NO = C1.V_HEAT_NO AND B1.SPEC_ABBSYM = C1.V_SPEC_ABBSYM  THEN 9  --일치 항목: 길이 > 두께(각) > Heat No > 강종
	                                                  WHEN B1.YD_MTL_L = C1.V_YD_MTL_L AND B1.YD_MTL_T = C1.V_YD_MTL_T AND B1.HEAT_NO = C1.V_HEAT_NO                                        THEN 8  --일치 항목: 길이 > 두께(각) > Heat No
	                                                  WHEN B1.YD_MTL_L = C1.V_YD_MTL_L AND B1.YD_MTL_T = C1.V_YD_MTL_T                                                                      THEN 7  --일치 항목: 길이 > 두께(각)
	                                                  WHEN B1.YD_MTL_L = C1.V_YD_MTL_L                                                                                                      THEN 6  --일치 항목: 길이
	                                                  ELSE 1 END)  AS SEQ_NUM
	                                      , SUM((CASE WHEN B1.YD_MTL_L = C1.V_YD_MTL_L AND B1.YD_MTL_T = C1.V_YD_MTL_T AND B1.HEAT_NO = C1.V_HEAT_NO AND B1.SPEC_ABBSYM = C1.V_SPEC_ABBSYM  THEN 1  --9점 짜리 재료 개수
	                                                  ELSE 0 END)) AS SEQ_9_SUM
	                                      , SUM((CASE WHEN B1.YD_MTL_L = C1.V_YD_MTL_L AND B1.YD_MTL_T = C1.V_YD_MTL_T AND B1.HEAT_NO = C1.V_HEAT_NO                                        THEN 1  --8점 짜리 재료 개수
	                                                  ELSE 0 END)) AS SEQ_8_SUM
	                                      , SUM((CASE WHEN B1.YD_MTL_L = C1.V_YD_MTL_L AND B1.YD_MTL_T = C1.V_YD_MTL_T                                                                      THEN 1  --7점 짜리 재료 개수
	                                                  ELSE 0 END)) AS SEQ_7_SUM
	                                      , SUM((CASE WHEN B1.YD_MTL_L = C1.V_YD_MTL_L                                                                                                      THEN 1  --6점 짜리 재료 개수
	...
	--                                      , CASE WHEN B1.YD_MTL_L = C1.V_YD_MTL_L AND B1.YD_MTL_T = C1.V_YD_MTL_T AND B1.HEAT_NO = C1.V_HEAT_NO AND B1.SPEC_ABBSYM = C1.V_SPEC_ABBSYM  THEN 9  --길이 > 두께(각) > Heat No > 강종
	--                                                 WHEN B1.YD_MTL_L = C1.V_YD_MTL_L AND B1.YD_MTL_T = C1.V_YD_MTL_T AND B1.HEAT_NO = C1.V_HEAT_NO                                    THEN 8  --길이 > 두께(각) > Heat No
	--                                                 WHEN B1.YD_MTL_L = C1.V_YD_MTL_L AND B1.YD_MTL_T = C1.V_YD_MTL_T                                                                  THEN 7  --길이 > 두께(각)
	--                                                 WHEN B1.YD_MTL_L = C1.V_YD_MTL_L                                                                                                  THEN 6  --길이
	--                                                 ELSE 1 END  AS SEQ_NUM
	 ...
	 * </pre>
	 */
	public final static String getToLocCol = "com.inisteel.cim.ys.ebt.dao.getToLocCol";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getToLocColByLocGuide
	-- 동일한 사양의 적치가능한 "열"(+"Max-BED/Max-단") 조회
	 ...
	 * </pre>
	 */
	public final static String getToLocColByLocGuide = "com.inisteel.cim.ys.ebt.dao.getToLocColByLocGuide";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getYdStkBedInfo
	 ...
	 * </pre>
	 */
	public final static String getYdStkBedInfo = "com.inisteel.cim.ys.ebt.dao.getYdStkBedInfo";
	
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getStkBedXY
	-- BED 좌표 정보 조회
	 ...
	 * </pre>
	 */
	public final static String getStkBedXY = "com.inisteel.cim.ys.ebt.dao.getStkBedXY";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.updCrnschXY
	-- 크레인스케줄(좌표 등) 정보 갱신
	 ...
	 * </pre>
	 */
	public final static String updCrnschXY = "com.inisteel.cim.ys.ebt.dao.updCrnschXY";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getStklyrInfoByCrnsch
	-- 권상위치 작업재료 조회
	 ...
	 * </pre>
	 */
	public final static String getStklyrInfoByCrnsch = "com.inisteel.cim.ys.ebt.dao.getStklyrInfoByCrnsch";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getStklyrMaxSeqNo
	 ...
	 * </pre>
	 */
	public final static String getStklyrMaxSeqNo = "com.inisteel.cim.ys.ebt.dao.getStklyrMaxSeqNo";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.updStkLyrToStlNoStat
	 ...
	 * </pre>
	 */
	public final static String updStkLyrToStlNoStat = "com.inisteel.cim.ys.ebt.dao.updStkLyrToStlNoStat";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getCrnSchStartGp
	-- 크레인스케줄 기동구분 조회 
	 ...
	 * </pre>
	 */
	public final static String getCrnSchStartGp = "com.inisteel.cim.ys.ebt.dao.getCrnSchStartGp";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getYsCrnSch
	-- 크레인스케줄 조회
	 ...
	 * </pre>
	 */
	public final static String getYsCrnSch = "com.inisteel.cim.ys.ebt.dao.getYsCrnSch";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getCrnWrkMtlCnt
	-- "품명별, 두께별, 길이별 크레인작업매수" 정보 조회
	
	WITH PARAM AS 
	(
	    SELECT :V_REPR_CD_GP AS V_REPR_CD_GP  --APPGI4
	         , :V_ITEM       AS V_ITEM        --야드구분: GE[옥내]/GF[옥외]
	         , :V_STLKND     AS V_STLKND      --재료구분: RR[봉강]/QT[각강]
	         , :V_YD_MTL_T   AS V_YD_MTL_T    --두께
	         , :V_YD_MTL_L   AS V_YD_MTL_L    --길이
	      FROM DUAL
	),
	TEMP_RANGE1 AS
	(
		SELECT A.*
		     , MIN(T_FROM)  OVER() AS T_FROM_MIN     --최소 두께
		     , MAX(T_TO)    OVER() AS T_TO_MAX       --최대 두께
		  FROM (
		  			-- REPR_CD_CONTENTS: 재료구분(RR[봉강]/QT[각강])#두께하한#두께상한#길이하한#길이상한#크레인작업매수. ex)QT#130#130#8#8#8
					SELECT R.ITEM
					     , REGEXP_SUBSTR(R.REPR_CD_CONTENTS, '(.*?)(#|$)',1,1,NULL,1)            AS STLKND   --재료 구분
					     , TO_NUMBER(REGEXP_SUBSTR(R.REPR_CD_CONTENTS, '(.*?)(#|$)',1,2,NULL,1)) AS T_FROM   --두께 이상
					     , TO_NUMBER(REGEXP_SUBSTR(R.REPR_CD_CONTENTS, '(.*?)(#|$)',1,3,NULL,1)) AS T_TO     --두께 이하
					     , TO_NUMBER(REGEXP_SUBSTR(R.REPR_CD_CONTENTS, '(.*?)(#|$)',1,4,NULL,1)) AS L_FROM   --길이 이상
					     , TO_NUMBER(REGEXP_SUBSTR(R.REPR_CD_CONTENTS, '(.*?)(#|$)',1,5,NULL,1)) AS L_TO     --길이 이하
					     , TO_NUMBER(REGEXP_SUBSTR(R.REPR_CD_CONTENTS, '(.*?)(#|$)',1,6,NULL,1)) AS MTL_CNT  --크레인작업재료매수
					  FROM TB_YS_RULE R
					     , PARAM      P
					 WHERE R.REPR_CD_GP = P.V_REPR_CD_GP
				       AND R.ITEM       = P.V_ITEM
				       AND R.DEL_YN     = 'N'
				     ORDER BY R.REPR_CD_GP, LENGTH(R.CD_GP), R.CD_GP
			   )     A
		     , PARAM B
		 WHERE A.STLKND = B.V_STLKND
		 ORDER BY A.T_FROM
	),
	TEMP_RANGE2 AS
	(
		SELECT TO_NUMBER(REGEXP_REPLACE(LISTAGG((CASE WHEN T_FROM = T_FROM_MIN THEN MTL_CNT END),',') WITHIN GROUP (ORDER BY T_FROM),     '([^,]+)(,\1)*(,|$)', '\1\3')) AS T_FROM_MIN_MTL_CNT  --최소 크레인작업재료매수
		     , TO_NUMBER(REGEXP_REPLACE(LISTAGG((CASE WHEN T_TO   = T_TO_MAX   THEN MTL_CNT END),',') WITHIN GROUP (ORDER BY T_TO),       '([^,]+)(,\1)*(,|$)', '\1\3')) AS T_TO_MAX_MTL_CNT    --최대 크레인작업재료매수
		  FROM TEMP_RANGE1
	)
	SELECT DISTINCT MTL_CNT
	  FROM (
				SELECT (     -- [두께] 범위에 포함될 경우
				        CASE WHEN T1.T_FROM IS NOT NULL AND T1.T_TO IS NOT NULL AND T1.L_FROM IS     NULL AND T1.L_TO IS     NULL 
				                  AND T1.T_FROM <= P.V_YD_MTL_T AND P.V_YD_MTL_T <= T1.T_TO
				             THEN T1.MTL_CNT
				             
				             -- [두께] 범위에 포함되고, [길이] 범위(이상~이하)에 포함될 경우
				             WHEN T1.T_FROM IS NOT NULL AND T1.T_TO IS NOT NULL AND T1.L_FROM IS NOT NULL AND T1.L_TO IS NOT NULL 
				                  AND T1.T_FROM <= P.V_YD_MTL_T AND P.V_YD_MTL_T <= T1.T_TO AND T1.L_FROM <> T1.L_TO AND T1.L_FROM <= P.V_YD_MTL_L AND P.V_YD_MTL_L <= T1.L_TO  -- 길이: m 단위로 변환하여 비교
				             THEN MTL_CNT
				             
				             -- 최대 [두께] 초과일 경우
				             WHEN T1.T_FROM IS NOT NULL AND T1.T_TO IS NOT NULL 
				                  AND T1.T_TO_MAX   < P.V_YD_MTL_T
				             THEN (SELECT T_TO_MAX_MTL_CNT FROM TEMP_RANGE2)
				             
				             -- 최소 [두께] 미만일 경우
				             WHEN T1.T_FROM IS NOT NULL AND T1.T_TO IS NOT NULL 
				                  AND T1.T_FROM_MIN > P.V_YD_MTL_T
	                         THEN (SELECT T_FROM_MIN_MTL_CNT FROM TEMP_RANGE2)
	                         
				        END) AS MTL_CNT
				  FROM TEMP_RANGE1 T1
				     , PARAM      P
		   )
	 WHERE MTL_CNT IS NOT NULL
	 * </pre>
	 */
	public final static String getCrnWrkMtlCnt = "com.inisteel.cim.ys.ebt.dao.getCrnWrkMtlCnt";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.insYSSchlog
	 ...
	 * </pre>
	 */
	public final static String insYSSchlog = "com.inisteel.cim.ys.ebt.dao.insYSSchlog";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getEmptyCol
	-- 소재가 없는 열 조회
	 ...
	 * </pre>
	 */
	public final static String getEmptyCol = "com.inisteel.cim.ys.ebt.dao.getEmptyCol";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getSRRExistYD
	-- 빌렛정정야드 적치대에 "봉강" 존재여부 확인
	...
	SELECT YS_STK_COL_GP
	     ...
	     , SSTL_NO
	  FROM TB_YS_STKLYR S
	 WHERE SUBSTR(YS_STK_COL_GP,1,4) = 'GE02'
	   AND SSTL_NO IN (
	                    SELECT SSTL_NO 
	                      FROM TB_YS_STOCK 
	                     WHERE SSTL_NO = S.SSTL_NO
	                       AND (STL_APPEAR_GP IN ('L','S') OR (STL_APPEAR_GP = 'Y' AND  ITEMNAME_CD = 'SRR'))
	                   )
	   AND ROWNUM = 1
	 * </pre>
	 */
	public final static String getSRRExistYD = "com.inisteel.cim.ys.ebt.dao.getSRRExistYD";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.updCrnWrkMgtDnLoc
	-- 크레인작업관리-권하지시위치 변경
	 ...
	 * </pre>
	 */
	public final static String updCrnWrkMgtDnLoc = "com.inisteel.cim.ys.ebt.dao.updCrnWrkMgtDnLoc";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getCarldInfoInqjlByYdWrkBook
	-- 차량번호로 작업예약 조회
	 ...
	 * </pre>
	 */
	public final static String getCarldInfoInqjlByYdWrkBook = "com.inisteel.cim.ys.ebt.dao.getCarldInfoInqjlByYdWrkBook";
	
	/**
	 * <pre>
	 com.inisteel.cim.ys.ebt.dao.getCarldInfoInqjlByCarFtmvMtl 
	-- 차량 스케줄번호로 차량이송재료 조회
	 ...
	 * </pre>
	 */
	public final static String getCarldInfoInqjlByCarFtmvMtl = "com.inisteel.cim.ys.ebt.dao.getCarldInfoInqjlByCarFtmvMtl";
	
	/**
	 * <pre>
	-- com.inisteel.cim.ys.ebt.dao.updYdStkcol
	-- 열정보 수정
	 ...
	 * </pre>
	 */
	public final static String updYdStkcol = "com.inisteel.cim.ys.ebt.dao.updYdStkcol";

	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.updTB_YS_STKLYR_MRSteel
	-- 적치단 재료 초기화 (명륜철강)
	
	UPDATE TB_YS_STKLYR SL 
	   SET SL.SSTL_NO = '', SL.YD_STK_LYR_ACT_STAT = 'E', SL.YD_STK_LYR_MTL_STAT = 'E'  --[E:적치가능][F:적치완료] / [E:적치가능][C:적치중][U:권상대기][D:권하대기] 
	 WHERE SL.SSTL_NO IN (
						    SELECT REGEXP_SUBSTR(SSTL_NOS, '[^,]+', 1, LEVEL) AS SSTL_NO
						      FROM (SELECT :V_SSTL_NOS AS SSTL_NOS FROM DUAL)
						   CONNECT BY REGEXP_SUBSTR(SSTL_NOS, '[^,]+', 1, LEVEL) IS NOT NULL
						 )
	 * </pre>
	 */
	public final static String updTB_YS_STKLYR_MRSteel = "com.inisteel.cim.ys.ebt.dao.updTB_YS_STKLYR_MRSteel";

	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.updTB_YS_STOCK_MRSteel
	-- 저장품 재료 초기화 (명륜철강)
	
	UPDATE TB_YS_STOCK SL 
	   SET SL.YS_STK_COL_GP = '', SL.YS_STK_BED_NO = '', SL.YS_STK_LYR_NO = '', SL.YS_STK_SEQ_NO = '', SL.YS_STR_LOC = ''
	 WHERE SL.SSTL_NO IN (
						    SELECT REGEXP_SUBSTR(SSTL_NOS, '[^,]+', 1, LEVEL) AS SSTL_NO
						      FROM (SELECT :V_SSTL_NOS AS SSTL_NOS FROM DUAL)
						   CONNECT BY REGEXP_SUBSTR(SSTL_NOS, '[^,]+', 1, LEVEL) IS NOT NULL
	 ...
	 * </pre>
	 */
	public final static String updTB_YS_STOCK_MRSteel = "com.inisteel.cim.ys.ebt.dao.updTB_YS_STOCK_MRSteel";

	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.updTB_PB_BUNDLECOMM_MRSteel
	-- 번들 공통 수정 (명륜철강)
	
	UPDATE USRPBA.TB_PB_BUNDLECOMM  -- GGM00101011(명륜임가공 이송위치), GGM10101011(명륜임가공 입고위치)
	   SET YD_GP         = 'G',        YD_BAY_GP     = 'G',  YD_EQP_GP     = 'M0', 
	       YS_STK_COL_NO = '01',       YS_STK_BED_NO = '01', YS_STK_LYR_NO = '01', YS_STK_SEQ_NO = '1',
	       YS_STR_LOC = 'GGM00101011', YS_STR_LOC_HIS1 = YS_STR_LOC, YS_STR_LOC_HIS2 = YS_STR_LOC_HIS1
	 WHERE BNDL_NO IN (
						    SELECT REGEXP_SUBSTR(SSTL_NOS, '[^,]+', 1, LEVEL) AS SSTL_NO
						      FROM (SELECT :V_SSTL_NOS AS SSTL_NOS FROM DUAL)
						   CONNECT BY REGEXP_SUBSTR(SSTL_NOS, '[^,]+', 1, LEVEL) IS NOT NULL
	 ...
	 * </pre>
	 */
	public final static String updTB_PB_BUNDLECOMM_MRSteel = "com.inisteel.cim.ys.ebt.dao.updTB_PB_BUNDLECOMM_MRSteel";

	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.updTB_PB_BILLETCOMM_MRSteel
	-- 빌렛 공통 수정 (명륜철강)
	
	UPDATE USRPBA.TB_PB_BILLETCOMM  -- GGM00101011(명륜임가공 이송위치), GGM10101011(명륜임가공 입고위치)
	   SET YD_GP         = 'G',        YD_BAY_GP     = 'G',  YD_EQP_GP     = 'M0', 
	       YS_STK_COL_NO = '01',       YS_STK_BED_NO = '01', YS_STK_LYR_NO = '01', YS_STK_SEQ_NO = '1',
	       YS_STR_LOC = 'GGM00101011', YS_STR_LOC_HIS1 = YS_STR_LOC, YS_STR_LOC_HIS2 = YS_STR_LOC_HIS1
	 WHERE BLT_NO IN (
	 ...
	 * </pre>
	 */
	public final static String updTB_PB_BILLETCOMM_MRSteel = "com.inisteel.cim.ys.ebt.dao.updTB_PB_BILLETCOMM_MRSteel";

	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.insWrkHist_MRSteel
	-- 대형옥외야드 -> 사외통합야드(명륜) 차량이송소재 데이터 백업
	
	INSERT INTO TB_YS_WRKHIST
	(
		 YD_WRK_HIST_ID
		,SSTL_NO
		,YD_GP
	...
	VALUES
	(
		 TO_CHAR(SYSDATE,'YYYYMMDDHH24MI') || TO_CHAR(USRYSA.YS_WRKHIST_SEQ.NEXTVAL , 'FM000000')
		,:V_SSTL_NO
		,:V_YD_GP
		
		,:V_YS_STK_COL_GP || :V_YS_STK_BED_NO
		,:V_YS_STK_LYR_NO
		,:V_YS_STK_SEQ_NO
		...
		,:V_USER_ID
		,SYSDATE
		,'대형옥외야드 -> 사외통합(명륜철강) 차량이송출고 소재정보'
	)
	 * </pre>
	 */
	public final static String insWrkHist_MRSteel = "com.inisteel.cim.ys.ebt.dao.insWrkHist_MRSteel";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.ebt.dao.getSpecAbbsym_Car
	-- 차량에 실린 재료의 강종 조회
	...
	SELECT SPEC_ABBSYM
	 ...
	 WHERE SSTL_NO = (
						SELECT SSTL_NO
						  FROM TB_YS_STKLYR 
						 WHERE YS_STK_COL_GP = 'GFTR11' 
						   AND SSTL_NO IS NOT NULL 
						   AND ROWNUM = 1
					 )
	 * </pre>
	 */
	public final static String getSpecAbbsym_Car = "com.inisteel.cim.ys.ebt.dao.getSpecAbbsym_Car";

	// 2026.03.27 이송소재상차확인 -->
	/**
	 * <pre>
	-- com.inisteel.cim.ys.ebt.dao.udtCarFtMvMtl
	-- 대형봉강옥외야드 YS_차량이송재료 테이블 내용 수정
	
	UPDATE TB_YS_CARFTMVMTL SET
	  YD_CAR_UPP_LOC_CD = DECODE(:V_YD_CAR_UPP_LOC_CD,  NULL, YD_CAR_UPP_LOC_CD, 'NULL', NULL, :V_YD_CAR_UPP_LOC_CD)
	, YS_STK_BED_NO = DECODE(:V_YS_STK_BED_NO,  NULL, YS_STK_BED_NO, 'NULL', NULL, :V_YS_STK_BED_NO)
	, YS_STK_LYR_NO = DECODE(:V_YS_STK_LYR_NO,  NULL, YS_STK_LYR_NO, 'NULL', NULL, :V_YS_STK_LYR_NO)
	, YS_STK_SEQ_NO = DECODE(:V_YS_STK_SEQ_NO,  NULL, YS_STK_SEQ_NO, 'NULL', NULL, :V_YS_STK_SEQ_NO)
	, HCR_GP = DECODE(:V_HCR_GP,  NULL, HCR_GP, 'NULL', NULL, :V_HCR_GP)
	, STL_PROG_CD = DECODE(:V_STL_PROG_CD,  NULL, STL_PROG_CD, 'NULL', NULL, :V_STL_PROG_CD)
	, YS_MTL_ITEM = DECODE(:V_YS_MTL_ITEM,  NULL, YS_MTL_ITEM, 'NULL', NULL, :V_YS_MTL_ITEM)
	, YS_ROUTE_GP = DECODE(:V_YS_ROUTE_GP,  NULL, YS_ROUTE_GP, 'NULL', NULL, :V_YS_ROUTE_GP)
	, MODIFIER = DECODE(:V_MODIFIER,  NULL, MODIFIER, 'NULL', NULL, :V_MODIFIER)
	, MOD_DDTT = SYSDATE
	WHERE 1=1
	 ...
	 * </pre>
	 */
	public final static String udtCarFtMvMtl = "com.inisteel.cim.ys.ebt.dao.udtCarFtMvMtl";
	
	/**
	 * <pre>
	-- com.inisteel.cim.ys.ebt.dao.udtCarIssueChkYn
	-- PDA 이송소재상차확인시 전문 전송 여부 업데이트
	
	UPDATE TB_YS_CARSCH SET
	YD_CAR_ISSUE_CHK_YN = :V_YD_CAR_ISSUE_CHK_YN
	WHERE 1=1
	AND YD_CAR_SCH_ID = :V_YD_CAR_SCH_ID
	 * </pre>
	 */
	public final static String udtCarIssueChkYn = "com.inisteel.cim.ys.ebt.dao.udtCarIssueChkYn";
	// 2026.03.27 이송소재상차확인 <--
}
