...
public interface YsQueryIFCbt {

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getSwitchOffYn
	-- 대형옥내야드-출하상(GEPC31/GEPC31/GEPC41/GEPC42/GEPC51) 모든 스위치 OFF 여부 체크 
	
	SELECT CASE WHEN EXISTS ( SELECT * FROM TB_YS_RULE WHERE REPR_CD_GP = 'GE0001' AND ITEM = 'Y' ) THEN 'N'  --[N:스위치 ON 존재  ]
			    ELSE 'Y'                                                                                      --[Y:스위치 ON 미존재]
		   END AS OFF_YN
	  FROM DUAL
	 * </pre>
	 */
	public final static String getSwitchOffYn = "com.inisteel.cim.ys.cbt.dao.getSwitchOffYn";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getMvStkWrkBookMtlPp
	-- 작업예약등록 이적재료조회
	...
	SELECT DISTINCT SL.SSTL_NO
	 ...
	 ORDER BY SL.YS_STK_COL_GP, SL.YS_STK_LYR_NO DESC,SL.YS_STK_BED_NO DESC,SL.YS_STK_SEQ_NO
	 * </pre>
	 */
	public final static String getMvStkWrkBookMtlPp = "com.inisteel.cim.ys.cbt.dao.getMvStkWrkBookMtlPp";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getStatSchCd
	-- 스케줄코드상태조회
	 ...
	 * </pre>
	 */
	public final static String getStatSchCd = "com.inisteel.cim.ys.cbt.dao.getStatSchCd";


	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.insWrkBook
	-- 작업예약 등록
	 ...
	 * </pre>
	 */
	public final static String insWrkBook_cbt = "com.inisteel.cim.ys.cbt.dao.insWrkBook";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.insWrkBookMtl
	-- 작업예약재료 등록
	 ...
	 * </pre>
	 */
	public final static String insWrkBookMtl_cbt = "com.inisteel.cim.ys.cbt.dao.insWrkBookMtl";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getStatEqp
	-- 설비상태조회 
	 ...
	 * </pre>
	 */
	public final static String getStatEqp = "com.inisteel.cim.ys.cbt.dao.getStatEqp";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getCrnSchWbook
	-- (작업예약ID) 작업예약ID 조회
	 ...
	 * </pre>
	 */
	public final static String getCrnSchWbook = "com.inisteel.cim.ys.cbt.dao.getCrnSchWbook";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getCrnSchWbookSchcd
	-- (스케줄코드) 작업예약ID 조회
	 ...
	 * </pre>
	 */
	public final static String getCrnSchWbookSchcd = "com.inisteel.cim.ys.cbt.dao.getCrnSchWbookSchcd";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getCrnSchWbookEqp
	-- (설비코드) 작업예약ID 조회
	 ...
	 * </pre>
	 */
	public final static String getCrnSchWbookEqp = "com.inisteel.cim.ys.cbt.dao.getCrnSchWbookEqp";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.updWmStrLoc
	 ...
	 * </pre>
	 */
	public final static String updWmStrLoc = "com.inisteel.cim.ys.cbt.dao.updWmStrLoc";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getCrnSchStat
	...
	SELECT WB.YD_GP                                                --야드구분
	      ...
	      ,(SELECT MIN(CASE WHEN SL.YS_STK_COL_GP||SL.YS_STK_BED_NO||SL.YS_STK_LYR_NO = CS.YS_DN_WO_LOC||YS_DN_WO_LAYER                                THEN '1'
	         ...
	         WHERE WM.SSTL_NO     = SL.SSTL_NO
	           ...
	           AND (SUBSTR(SL.YS_STK_COL_GP,3,2) NOT IN ('TF') OR (SUBSTR(SL.YS_STK_COL_GP,3,2) = 'TR' AND WB.YD_SCH_CD NOT LIKE '__TR__U_'))  -- 작업중복(적치/권상/권하)이 가능한 보급대or차량상차 시 CHECK 안함 => 보급대[TF], 추출대[PC], 보급/추출대[TR]
	           AND WM.YD_WBOOK_ID = WB.YD_WBOOK_ID
	           AND WM.DEL_YN      = 'N'
	           AND SL.DEL_YN      = 'N'
	 ...
	 * </pre>
	 */
	public final static String getCrnSchStat = "com.inisteel.cim.ys.cbt.dao.getCrnSchStat";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getWorkBookColGpBedGroupTr
	-- 작업예약재료들의 위치('열/BED/단')정보 조회
	 ...
	 * </pre>
	 */
	public final static String getWorkBookColGpBedGroupTr = "com.inisteel.cim.ys.cbt.dao.getWorkBookColGpBedGroupTr";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getStkLyrbyWBookIdGroupTr
	 ...
	 * </pre>
	 */
	public final static String getStkLyrbyWBookIdGroupTr = "com.inisteel.cim.ys.cbt.dao.getStkLyrbyWBookIdGroupTr";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getWorkBookColGpGroup
	 ...
	 * </pre>
	 */
	public final static String getWorkBookColGpGroup = "com.inisteel.cim.ys.cbt.dao.getWorkBookColGpGroup";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getStkLyrbyWBookIdGroupV1
	...
	SELECT *
	  FROM (
	            SELECT X.SSTL_NO       
	                 ...
	                 , (SELECT MAX(YD_SCH_CD) AS YD_SCH_CD FROM TB_YS_WRKBOOK WHERE YD_WBOOK_ID = :V_YD_WBOOK_ID AND DEL_YN ='N') AS YD_SCH_CD  --추가
                 	 ,Y.ITEMNAME_CD --추가
	 ...
	 * </pre>
	 */
	public final static String getStkLyrbyWBookIdGroupV1 = "com.inisteel.cim.ys.cbt.dao.getStkLyrbyWBookIdGroupV1";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getYdStklyrSstl
	-- 크레인스케줄(권상위치) 재료정보 조회
	 ...
	 * </pre>
	 */
	public final static String getYdStklyrSstl = "com.inisteel.cim.ys.cbt.dao.getYdStklyrSstl";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.insYdCrnsch
	-- 크레인스케줄 등록
	 ...
	 * </pre>
	 */
	public final static String insYdCrnsch = "com.inisteel.cim.ys.cbt.dao.insYdCrnsch";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.updYdStkLyrMtlStat
	 ...
	 * </pre>
	 */
	public final static String updYdStkLyrMtlStat = "com.inisteel.cim.ys.cbt.dao.updYdStkLyrMtlStat";

	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.insYdCrnwrkmtl
	-- 크레인스케줄 작업재료 등록
	 ...
	 * </pre>
	 */
	public final static String insYdCrnwrkmtl = "com.inisteel.cim.ys.cbt.dao.insYdCrnwrkmtl";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getYdWrkbook
	-- 작업예약 조회
	 ...
	 * </pre>
	 */
	public final static String getYdWrkbook = "com.inisteel.cim.ys.cbt.dao.getYdWrkbook";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getYdCrnschByEqpIdandWBookId
	-- 크레인스케줄 조회
	 ...
	 * </pre>
	 */
	public final static String getYdCrnschByEqpIdandWBookId = "com.inisteel.cim.ys.cbt.dao.getYdCrnschByEqpIdandWBookId";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getYdCrnwrkmtlBySchId
	-- 크레인스케줄 작업재료 조회
	 ...
	 * </pre>
	 */
	public final static String getYdCrnwrkmtlBySchId = "com.inisteel.cim.ys.cbt.dao.getYdCrnwrkmtlBySchId";
	...
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getYdStock
	-- 저장품정보 조회
	 ...
	 * </pre>
	 */
	public final static String getYdStock = "com.inisteel.cim.ys.cbt.dao.getYdStock";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getYdStklyrSTLNO
	-- 적재위치정보 조회
	 ...
	 * </pre>
	 */
	public final static String getYdStklyrSTLNO = "com.inisteel.cim.ys.cbt.dao.getYdStklyrSTLNO";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getToLocCol
				      ...
				      FROM (
				                SELECT B.YS_STK_COL_GP  AS M_TO_LOC_ZONE
				                 ...
				                 WHERE A.YD_LOC_SRCH_RNG_REG_SNO = B.YD_LOC_SRCH_RNG_REG_SNO
				                   ...
				                   AND A.YS_ROUTE_GP   = (CASE WHEN P.V_YD_SCH_CD IN ('GETR41LB','GEYD01MB','GETR21LB') THEN P.V_STLKND 
	      ...
	      FROM (
	                SELECT B.YS_STK_COL_GP  AS W_TO_LOC_ZONE
	                 ...
	                 WHERE A.YD_LOC_SRCH_RNG_REG_SNO = B.YD_LOC_SRCH_RNG_REG_SNO
	                   ...
	                   AND A.YS_ROUTE_GP   = (CASE WHEN P.V_YD_SCH_CD IN ('GETR41UB','GEYD01MB','GETR21UB','GETF02LB') THEN P.V_STLKND 
	                                               ELSE A.YD_STR_GTR_CD END)  --강종: [RR:SRR][QT:SRQ/SRI,SRW]
	           )
	 ...
	 * </pre>
	 */
	public final static String getToLocCol = "com.inisteel.cim.ys.cbt.dao.getToLocCol";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getToLocColByLocGuide
	-- 동일한 사양의 적치가능한 "열"(+"Max-BED/Max-단") 조회
	 ...
	 * </pre>
	 */
	public final static String getToLocColByLocGuide = "com.inisteel.cim.ys.cbt.dao.getToLocColByLocGuide";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getYdStkBedInfo
	 ...
	 * </pre>
	 */
	public final static String getYdStkBedInfo = "com.inisteel.cim.ys.cbt.dao.getYdStkBedInfo";
	
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getStkBedXY
	-- BED 좌표 정보 조회
	 ...
	 * </pre>
	 */
	public final static String getStkBedXY = "com.inisteel.cim.ys.cbt.dao.getStkBedXY";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.updCrnschXY
	-- 크레인스케줄(좌표 등) 정보 갱신
	 ...
	 * </pre>
	 */
	public final static String updCrnschXY = "com.inisteel.cim.ys.cbt.dao.updCrnschXY";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getStklyrInfoByCrnsch
	-- 권상위치 작업재료 조회
	 ...
	 * </pre>
	 */
	public final static String getStklyrInfoByCrnsch = "com.inisteel.cim.ys.cbt.dao.getStklyrInfoByCrnsch";


	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getStklyrDescInfoByCrnsch
	-- 권상위치 작업재료를 'SEQ_NO' 역순으로 조회
	...
	,RESULT_DESC AS (
		SELECT S.YS_STK_SEQ_NO AS YS_STK_SEQ_NO
		     , ROW_NUMBER() OVER(ORDER BY YS_STK_COL_GP, S.YS_STK_BED_NO, S.YS_STK_LYR_NO, S.YS_STK_SEQ_NO DESC) AS ROW_NUM
		  FROM TB_YS_STKLYR S
		     , PARAM        P
		 WHERE S.YS_STK_COL_GP = P.V_YS_STK_COL_GP
		   AND S.YS_STK_BED_NO = P.V_YS_STK_BED_NO
		   ...
		   AND S.SSTL_NO IN (SELECT SSTL_NO FROM TB_YS_CRNWRKMTL WHERE YD_CRN_SCH_ID = P.V_YD_CRN_SCH_ID)
		   AND S.DEL_YN        = 'N'
		 ORDER BY S.YS_STK_COL_GP, S.YS_STK_BED_NO, S.YS_STK_LYR_NO, S.YS_STK_SEQ_NO DESC
	)
	SELECT A.YS_STK_COL_GP
	     , A.YS_STK_BED_NO
	     , A.YS_STK_LYR_NO
	  ...
	  FROM (
				SELECT S.YS_STK_COL_GP AS YS_STK_COL_GP
				     ...
				     , S.YS_STK_SEQ_NO AS YS_STK_SEQ_NO
				     , S.SSTL_NO       AS SSTL_NO
				     , ROW_NUMBER() OVER(ORDER BY YS_STK_COL_GP, S.YS_STK_BED_NO, S.YS_STK_LYR_NO, S.YS_STK_SEQ_NO) AS ROW_NUM
				  FROM TB_YS_STKLYR S
				     , PARAM        P
				 WHERE S.YS_STK_COL_GP = P.V_YS_STK_COL_GP
				   AND S.YS_STK_BED_NO = P.V_YS_STK_BED_NO
	     ...
	     , RESULT_DESC R
	 WHERE A.ROW_NUM = R.ROW_NUM

	 * </pre>
	 */
	public final static String getStklyrDescInfoByCrnsch = "com.inisteel.cim.ys.cbt.dao.getStklyrDescInfoByCrnsch";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getStklyrMaxSeqNo
	 ...
	 * </pre>
	 */
	public final static String getStklyrMaxSeqNo = "com.inisteel.cim.ys.cbt.dao.getStklyrMaxSeqNo";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.updStkLyrToStlNoStat
	 ...
	 * </pre>
	 */
	public final static String updStkLyrToStlNoStat = "com.inisteel.cim.ys.cbt.dao.updStkLyrToStlNoStat";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getCrnSchStartGp
	-- 크레인스케줄 기동구분 조회 
	 ...
	 * </pre>
	 */
	public final static String getCrnSchStartGp = "com.inisteel.cim.ys.cbt.dao.getCrnSchStartGp";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getYsCrnSch
	-- 크레인스케줄 조회
	 ...
	 * </pre>
	 */
	public final static String getYsCrnSch = "com.inisteel.cim.ys.cbt.dao.getYsCrnSch";
	
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getCrnWrkMtlCnt
	 ...
	 * </pre>
	 */
	public final static String getCrnWrkMtlCnt = "com.inisteel.cim.ys.cbt.dao.getCrnWrkMtlCnt";
	...
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getSRRExistYD
	 ...
	 * </pre>
	 */
	public final static String getSRRExistYD = "com.inisteel.cim.ys.cbt.dao.getSRRExistYD";
	

	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.updCrnWrkMgtDnLoc
	-- 크레인작업관리-권하지시위치 변경
	 ...
	 * </pre>
	 */
	public final static String updCrnWrkMgtDnLoc = "com.inisteel.cim.ys.cbt.dao.updCrnWrkMgtDnLoc";
	
	/**
	 * <pre>
	com.inisteel.cim.ys.cbt.dao.getCarldInfoInqjlByYdWrkBook
	-- 차량번호로 작업예약 조회
	 ...
	 * </pre>
	 */
	public final static String getCarldInfoInqjlByYdWrkBook = "com.inisteel.cim.ys.cbt.dao.getCarldInfoInqjlByYdWrkBook";
	
	/**
	 * <pre>
	 com.inisteel.cim.ys.cbt.dao.getCarldInfoInqjlByCarFtmvMtl 
	-- 차량 스케줄번호로 차량이송재료 조회
	 ...
	 * </pre>
	 */
	public final static String getCarldInfoInqjlByCarFtmvMtl = "com.inisteel.cim.ys.cbt.dao.getCarldInfoInqjlByCarFtmvMtl";
	
	/**
	 * <pre>
	-- com.inisteel.cim.ys.cbt.dao.updYdStkcol
	-- 열정보 수정
	 ...
	 * </pre>
	 */
	public final static String updYdStkcol = "com.inisteel.cim.ys.cbt.dao.updYdStkcol";
	 ...
	 * </pre>
	 */
	public final static String aaaaaaa = "com.inisteel.cim.ys.cbt.dao.aaaaaaa";
