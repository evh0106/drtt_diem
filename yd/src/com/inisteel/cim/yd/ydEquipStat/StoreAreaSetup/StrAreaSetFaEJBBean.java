package com.inisteel.cim.yd.ydEquipStat.StoreAreaSetup;
...
/**
 * 저장영역설정 Facade Session EJB
 *
 * @ejb.bean name="StrAreaSetFaEJB" jndi-name="StrAreaSetFaEJB" type="Stateless"
 *           view-type="remote" display-name="" description=""
 * @weblogic.enable-call-by-reference True
 * @weblogic.pool initial-beans-in-free-pool="10" max-beans-in-free-pool="100"
 * @ejb.transaction type="Required"
 */
public class StrAreaSetFaEJBBean extends BaseSessionBean {
...
//		} // end of try catch
  ...
  //---------------------------------------------------------------------------	
} // end of class StrAreaSetFaEJBBean
