...
public class PSlabYdComScript {

	private PSlabYdComScript() {
	}

	/**
	 * get Reference.
	 */
	public static PSlabYdComScript getInstance() {
		return new PSlabYdComScript();
	}
	...
	public String getSelectBox(String sObjNm, String sStdItm, String sCatId, String sOptionDefault, String sSelectStr, String sViewString, int iSize, String sChangeEvent) throws Exception {
		...
		if (sStyleWidth.equals("0") || iSize == 0) {
			sStyleWidth = "";
		}
	 ...
	 * sType : C:Char, N:Number
	 */
	public String getCrnListBox(String crnId) {
		String ydGp = crnId.substring(0, 1);
		String ydBayGp = crnId.substring(1, 2);
		
		System.out.println("ydGp : " + ydGp);
		System.out.println("ydBayGp : " + ydBayGp);
