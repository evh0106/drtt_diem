...
public class JPlateYdMakeTcY9 {
	...
	// 클래스명
	private static final String SZ_CLASS_NAME  = JPlateYdMakeTcY9.class.getName();
	 ...
	 */
	public static int makeYDY9L501(JDTORecord inRec, JDTORecordSet outRecSet) {
		//		1.	전문 ID					MSG_ID					VARCHAR2(8)		YDY9L501
		...
		// 변수선언
		String szMethodName     	= "makeYDY9L501";
...
//2후판거 사용			
			...
			for(int ii=0; ii<intRtnVal; ii++) {
				...
				outRec.setField("MSG_ID", 				"YDY9L501");
				...
				// Debug MSG
				ydUtils.putLog(SZ_CLASS_NAME, szMethodName, "\n======================makeYDY5L501() OUT("+ Integer.toString(ii) + ")==========================\n", JPlateYdConst.DEBUG);
				ydUtils.displayRecord(szOperationName, outRec);
				ydUtils.putLog(SZ_CLASS_NAME, szMethodName, "\n================================================================\n", JPlateYdConst.DEBUG);
			}
		}catch(Exception e) {
			szMsg = "Y9(1후판정정야드L2) 송신  저장위치제원  데이터 반환 중 예외발생! 예외메세지: " + e.getMessage();
			ydUtils.putLog(SZ_CLASS_NAME, szMethodName, szMsg, JPlateYdConst.ERROR);
			return -1;
		}
	 ...
	 * @return JDTORecord msgRec
	 */
	public static int makeYDY9L502(JDTORecord inRec, JDTORecordSet outRecSet) {
		//		1.	전문 ID						MSG_ID					VARCHAR2(8)		YDY9L502
		//		2.	생성일						DATE					VARCHAR2(10)	YYYY-MM-DD
		//		3.	생성시간						TIME					VARCHAR2(8)		24HH-MM-SS
		//		4.	전문구분						MSG_GP					VARCHAR2(1)		I(신규), U(수정), D(취소,삭제), R(재 전송)
		//		5.	전문길이						MSG_LEN					NUMBER  (4)
		...
		// 변수선언
		String 	szMethodName    = "makeYDY9L502";
		...
		try{
			...
			if (!"".equals(szArrStlNo)) {
				...
				if (arrStlNo == null || arrStlNo.length < 1) {
					szMsg = "Y9 (1후판정정L2) 송신  저장품제원  데이터중 재료번호 오류 : " + szArrStlNo;
					ydUtils.putLog(SZ_CLASS_NAME, szMethodName, szMsg, JPlateYdConst.ERROR);
					return -1;
				}
...
//2후판거 사용
			...
			for(int ii=0; ii<iLoopCnt; ii++) {
				...
				// 헤더부
				outRec = JDTORecordFactory.getInstance().create();
				outRec.setField("MSG_ID", 				"YDY9L502");
				outRec.setField("DATE", 				JPlateYdUtils.getCurDate("yyyy-MM-dd"));
				outRec.setField("TIME", 				JPlateYdUtils.getCurDate("HH-mm-ss"));
			...
			//	outRec.setField("URGENT_FRTOMOVE_WORD_GP", 	JPlateYdUtils.fillSpZrRec(recGetVal, "URGENT_FRTOMOVE_WORD_GP", 1, 1));
				...
				// Debug MSG
				ydUtils.putLog(SZ_CLASS_NAME, szMethodName, "\n======================makeYDY9L502() OUT("+ Integer.toString(ii) + ")==========================\n", JPlateYdConst.DEBUG);
				ydUtils.displayRecord(szOperationName, outRec);
				ydUtils.putLog(SZ_CLASS_NAME, szMethodName, "\n================================================================\n", JPlateYdConst.DEBUG);
			}
		}catch(Exception e) {
			szMsg = "Y9(1후판정정야드L2) 송신  저장품제원  데이터 반환 중 예외발생! 예외메세지: " + e.getMessage();
			ydUtils.putLog(SZ_CLASS_NAME, szMethodName, szMsg, JPlateYdConst.ERROR);
			return -1;
		}
	 ...
	 * @return JDTORecord msgRec
	 */
	public static int makeYDY9L504(JDTORecord inRec, JDTORecordSet outRecSet) {

		//		1.	전문 ID					MSG_ID					VARCHAR2(8)		YDY9L504
		//		2.	생성일					DATE					VARCHAR2(10)	YYYY-MM-DD
		//		3.	생성시간					TIME					VARCHAR2(8)		24HH-MM-SS
		//		4.	전문구분					MSG_GP					VARCHAR2(1)		I(신규), U(수정), D(취소,삭제), R(재 전송)
		...
		// 변수선언
		String 	szMethodName     	= "makeYDY9L504";
		String 	szMsg            	= "";
...
*/
			// 헤더부
			outRec.setField("MSG_ID", 		"YDY9L504");
			outRec.setField("DATE", 		JPlateYdUtils.getCurDate("yyyy-MM-dd"));
			outRec.setField("TIME", 		JPlateYdUtils.getCurDate("HH-mm-ss"));
		...
		//	outRec.setField("YD_DN_WO_LOC_YAXIS2", 		JPlateYdUtils.fillSpZrRec(recCrnSch, "YD_DN_WO_LOC_YAXIS", 5, 0));
			...
			szMsg = "Y9(1후판정정야드L2) 송신  크레인작업지시  데이터 반환 중 예외발생! 예외메세지: " + e.getMessage();
			ydUtils.putLog(SZ_CLASS_NAME, szMethodName, szMsg, JPlateYdConst.ERROR);
			return -1;
		}
	 ...
	 * @return JDTORecord msgRec
	 */
	public static int makeYDY9L505(JDTORecord inRec, JDTORecordSet outRecSet) {
		//		1.	전문 ID				MSG_ID				VARCHAR2(8)		YDY9L505
		//		2.	생성일				DATE				VARCHAR2(10)	YYYY-MM-DD
		//		3.	생성시간				TIME				VARCHAR2(8)		24HH-MM-SS
		//		4.	전문구분				MSG_GP				VARCHAR2(1)		I(신규), U(수정), D(취소,삭제), R(재 전송)
		//		5.	전문길이				MSG_LEN				NUMBER  (4)
		...
		// 변수선언
		String 	szMethodName    = "makeYDY9L505";
		...
		try {
			...
			// 헤더부
			outRec.setField("MSG_ID" , "YDY9L505");
			outRec.setField("DATE"   , JPlateYdUtils.getCurDate("yyyy-MM-dd"));
			outRec.setField("TIME"   , JPlateYdUtils.getCurDate("HH-mm-ss"));
			outRec.setField("MSG_GP" , "I");
			outRec.setField("MSG_LEN", JPlateYdUtils.fillSpZr(Integer.toString(nTcLen), 4, 0));
			...
			szMsg = "Y9(1후판정정야드L2) 송신  크레인작업실적응답  데이터 반환 중 예외발생! 예외메세지: " + e.getMessage();
			ydUtils.putLog(SZ_CLASS_NAME, szMethodName, szMsg, JPlateYdConst.ERROR);
			return -1;
		}
	 ...
	 * @return JDTORecord msgRec
	 */
	public static int makeYDY9L506(JDTORecord inRec, JDTORecordSet outRecSet) {
		//		1.	전문 ID				MSG_ID				VARCHAR2(8)		YDY9L506
		//		2.	생성일				DATE				VARCHAR2(10)	YYYY-MM-DD
		//		3.	생성시간				TIME				VARCHAR2(8)		24HH-MM-SS
		//		4.	전문구분				MSG_GP				VARCHAR2(1)		I(신규), U(수정), D(취소,삭제), R(재 전송)
		//		5.	전문길이				MSG_LEN				NUMBER  (4)
		...
		// 변수선언
		String szMethodName     = "makeYDY9L506";
		String szMsg            = "";
		...
		try {
			...
			/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	         * 업무 : 가이던스메세지 전문 편집(YDY9L506)
	         +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
			outRec = JDTORecordFactory.getInstance().create();

			// 헤더부
			outRec.setField("MSG_ID", 			"YDY9L506");
			outRec.setField("DATE", 			JPlateYdUtils.getCurDate("yyyy-MM-dd"));
			outRec.setField("TIME", 			JPlateYdUtils.getCurDate("HH-mm-ss"));
			outRec.setField("MSG_GP", 			"I");
			outRec.setField("MSG_LEN", 			JPlateYdUtils.fillSpZr(Integer.toString(nTcLen), 4, 0));
			...
			szMsg = "Y9(1후판정정야드L2) 송신  가이던스메세지  데이터 반환 중 예외발생! 예외메세지: " + e.getMessage();
			ydUtils.putLog(SZ_CLASS_NAME, szMethodName, szMsg, JPlateYdConst.ERROR);
			return -1;
		}
	 ...
	 * @return JDTORecord msgRec
	 */
	public static int makeYDY9L507(JDTORecord inRec, JDTORecordSet outRecSet) {
		//		1.	전문 ID				MSG_ID				VARCHAR2(8)		YDY9L507
		//		2.	생성일				DATE				VARCHAR2(10)	YYYY-MM-DD
		//		3.	생성시간				TIME				VARCHAR2(8)		24HH-MM-SS
		//		4.	전문구분				MSG_GP				VARCHAR2(1)		I(신규), U(수정), D(취소,삭제), R(재 전송)
		...
		// 변수선언
		String szMethodName     = "makeYDY9L507";
		String szMsg            = "";
		...
		try {
			...
			/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	         * 업무 : 크레인작업메세지 전문 편집(YDY9L507)
	         +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
			outRec = JDTORecordFactory.getInstance().create();

			// 헤더부
			outRec.setField("MSG_ID", 			"YDY9L507");
			outRec.setField("DATE", 			JPlateYdUtils.getCurDate("yyyy-MM-dd"));
			outRec.setField("TIME", 			JPlateYdUtils.getCurDate("HH-mm-ss"));
			outRec.setField("MSG_GP", 			"I");
			outRec.setField("MSG_LEN", 			JPlateYdUtils.fillSpZr(Integer.toString(nTcLen), 4, 0));
			...
			szMsg = "Y9(1후판정정야드L2) 송신  크레인작업메세지  데이터 반환 중 예외발생! 예외메세지: " + e.getMessage();
			ydUtils.putLog(SZ_CLASS_NAME, szMethodName, szMsg, JPlateYdConst.ERROR);
			return -1;
		}
