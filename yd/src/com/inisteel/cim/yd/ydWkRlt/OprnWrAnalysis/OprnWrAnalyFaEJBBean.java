package com.inisteel.cim.yd.ydWkRlt.OprnWrAnalysis;
...
/**
 * 가동실적분석 Facade Session EJB
 *
 * @ejb.bean name="OprnWrAnalyFaEJB" jndi-name="OprnWrAnalyFaEJB" type="Stateless"
 *           view-type="remote" display-name="" description=""
 * @weblogic.enable-call-by-reference True
 * @weblogic.pool initial-beans-in-free-pool="10" max-beans-in-free-pool="100"
 * @ejb.transaction type="Required"
 */
public class OprnWrAnalyFaEJBBean extends BaseSessionBean {
...
//		} // end of try catch
  ...
  //---------------------------------------------------------------------------	
} // end of class OprnWrAnalyFaEJBBean
