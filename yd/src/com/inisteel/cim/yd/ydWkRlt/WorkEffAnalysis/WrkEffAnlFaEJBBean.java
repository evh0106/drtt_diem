...
/**
 * 작업효율분석 Facade Session EJB
 *
 * @ejb.bean name="WrkEffAnlFaEJB" jndi-name="WrkEffAnlFaEJB" type="Stateless"
 *           view-type="remote" display-name="" description=""
 * @weblogic.enable-call-by-reference True
 * @weblogic.pool initial-beans-in-free-pool="10" max-beans-in-free-pool="100"
 * @ejb.transaction type="Required"
 */
public class WrkEffAnlFaEJBBean extends BaseSessionBean {
...
//		} // end of try catch
  ...
  //---------------------------------------------------------------------------	
} // end of class WrkEffAnlFaEJBBean
