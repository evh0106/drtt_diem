 ...
 * 위치정합성관리 Session EJB
 *
 * @ejb.bean name="LocFitnessMgtSeEJB" jndi-name="LocFitnessMgtSeEJB" type="Stateless"
 *           view-type="remote" display-name="" description=""
 * @weblogic.enable-call-by-reference True
 * @weblogic.pool initial-beans-in-free-pool="10" max-beans-in-free-pool="100"
 * @ejb.transaction type="Required"
 */
public class LocFitnessMgtSeEJBBean extends BaseSessionBean {
  ...
  //---------------------------------------------------------------------------	
} // end of class LocFitnessMgtSeEJBBean
