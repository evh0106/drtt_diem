package com.inisteel.cim.yd.ydWkPlan.ReceiptWkPlan;
...
/**
 * 입고작업계획 Facade Session EJB
 *
 * @ejb.bean name="RcptWrkPlnFaEJB" jndi-name="RcptWrkPlnFaEJB" type="Stateless"
 *           view-type="remote" display-name="" description=""
 * @weblogic.enable-call-by-reference True
 * @weblogic.pool initial-beans-in-free-pool="10" max-beans-in-free-pool="100"
 * @ejb.transaction type="Required"
 */
public class RcptWrkPlnFaEJBBean extends BaseSessionBean {
...
//		} // end of try catch
  ...
  //---------------------------------------------------------------------------	
} // end of class RcptWrkPlnFaEJBBean
