...
/**
 * 출고작업계획 Facade Session EJB
 *
 * @ejb.bean name="IssueWrkPlnFaEJB" jndi-name="IssueWrkPlnFaEJB" type="Stateless"
 *           view-type="remote" display-name="" description=""
 * @weblogic.enable-call-by-reference True
 * @weblogic.pool initial-beans-in-free-pool="10" max-beans-in-free-pool="100"
 * @ejb.transaction type="Required"
 */
public class IssueWrkPlnFaEJBBean extends BaseSessionBean {
...
//		} // end of try catch
  ...
  //---------------------------------------------------------------------------	
} // end of class IssueWrkPlnFaEJBBean
