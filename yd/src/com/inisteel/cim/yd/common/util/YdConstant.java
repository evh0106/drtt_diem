 ...
 * Ver.    수정일자           요청자       수정자         내용
 * =====  ===========  ======  ======  ==================================================
 * V1.01  2012.12.17   조병기      조병기      야드구분 상수 "2후판제품창고야드" 추가
 * V1.02  2012.12.18   조병기      조병기      2후판 제품창고 개소코드 추가
 */
...
public class YdConstant {
	...
	* 야드업무 내부적으로 사용되는 함수리턴코드 정의
	...
	public static final String YD_GP_PLATE_JJ_YARD						= "P";				//1후판정정야드
	...
	// 복수동 상차 우선순위 기본값
	public static final String YD_BAYIN_WO_SEQ_DOUBLE					= "5";
	
	//야드배차순서 기본값
	public static final String YD_CARASGN_SEQ_AUTO_DEFAULT				= "9";				//자동이송LOT편성일 경우 기본값
	
	//24.03.13 야드 수동 배차순서 기본값 99 ->70 수정 연주 김충만 계장 요청. 
	//(99로하면 뒤로 미룰수가 없다. 최대 60~70개 정도 선 등록하니, 디폴트 70 이후 낮추거나 높이거나할수있게끔) 
	public static final String YD_CARASGN_SEQ_MAN_DEFAULT				= "70";				//수동이송LOT편성일 경우 기본값
	...
	public static final String WLOC_CD_TOT_SLAB_YARD					= "DJY25";			//항만슬라브야드(옥내 Yard) 추가 - 2015.12.24 LeeJY
	...
	public static final String EQP_P_DP1								= "MADP01";			//항만 A동 Scarfing : 항만슬라브야드 기능추가 - 2015.12.30 LeeJY
	public static final String EQP_P_PU1								= "MBPU01";			//항만 B동 PickUp   : 항만슬라브야드 기능추가 - 2015.12.30 LeeJY
...
//DONG_INSERT	
	...
	public static final String YD_EQP_GP_ROLLERTABLE           = "RT"; //RT
	public static final String YD_EQP_GP_TRANSFER              = "TF"; //트랜스퍼
	public static final String YD_EQP_GP_YARD                  = "YD"; //트랜스퍼
	public static final String YD_EQP_GP_SORTINGLINE           = "SL"; //선별
