package com.inisteel.cim.yd.common.dao.ydWtClMtlDao;
...
public class YdWtClMtlDao {
	...
	//select query id
	private String szQueryIdGet1 = "com.inisteel.cim.yd.dao.ydwtclmtldao.YdWtclmtlDao.getYdWtclmtl";
	private String szQueryIdGet2 = "com.inisteel.cim.yd.dao.ydwtclmtldao.YdWtclmtlDao.getYdWtclmtlID";
	//insert query id
	private String szQueryIdIns1 = "com.inisteel.cim.yd.dao.ydwtclmtldao.YdWtclmtlDao.insYdWtclmtl";
	//update query id
	private String szQueryIdUpd1 = "com.inisteel.cim.yd.dao.ydwtclmtldao.YdWtclmtlDao.updYdWtclmtl";
...
/*------------------------------------- SELECT -------------------------------------------*/
	...
	/**
	 *      [A] 오퍼레이션명 : 야드수냉재료 SELECT
	 *      
	 * @param  JDTORecord inRec         parameter record
	 *         JDTORecordSet outRecSet  return recordSet
	 *         int intGp                구분(0:YD_WTCL_TNK_SCH_ID,STL_NO, 1:YD_WTCL_TNK_SCH_ID)
	 * @return int                      record count:성공, 0:data not found, -2:parameter error
	 * @throws DAOException
	 * @throws JDTOException 
	 */	
	public int getYdWtclmtl(JDTORecord inRec, JDTORecordSet outRecSet, int intGp) throws DAOException, JDTOException {
		...
		try {
			...
			//parameter check
			blnChk_Field = this.chkPara_getYdWtclmtl(recPara, intGp);
	...
	/**
	 *      [A] 오퍼레이션명 : 야드수냉재료 SELECT parameter Check
	 * 
	 * @param  JDTORecord inRec  parameter record
	 *         int        intGp  구분(0:YD_WTCL_TNK_SCH_ID,STL_NO, 1:YD_WTCL_TNK_SCH_ID)
	 ...
	 * @throws JDTOException 
	 */	
	public boolean chkPara_getYdWtclmtl(JDTORecord inRec, int intGp) throws JDTOException  {
...
/*------------------------------------- INSERT -------------------------------------------*/
	 ...
	 * @throws JDTOException 
	 */		
	public int insYdWtclmtl(JDTORecord inRec) throws DAOException, JDTOException {
		int intRtnVal = 0;
		boolean blnChk_Field = true;
		JDTORecord recPara = null;
...
/*------------------------------------- UPDATE -------------------------------------------*/
	...
	/**
	 *      [A] 오퍼레이션명 : 야드수냉재료 UPDATE
	 * 
	 * @param  JDTORecord inRec parameter record
	 *         int        intGp 구분(0:YD_WTCL_TNK_SCH_ID,STL_NO)
	 * @return int              execution count(성공), 0:data not found, -1:dup_val_on_index, -2:parameter error, -3:execution failed
	 * @throws DAOException
	 * @throws JDTOException 
	 */		
	public int updYdWtclmtl(JDTORecord inRec, int intGp) throws DAOException, JDTOException {
		String szMethodName = "updYdWtclmtl";
		String szMsg = null;
		...
		try {
			...
			//update data select
			intRtnVal = this.getYdWtclmtl(inRec, outRecSet, intGp);
	...
	/**
	 *      [A] 오퍼레이션명 : 야드수냉재료 parameter Check
	 * 
	 * @param JDTORecord inRec parameter record
	 * @return boolean         true(성공), false(실패)
	 * @throws JDTOException 
...
//			if (!blnErr) return blnErr;
	...
	/**
	 *      [A] 오퍼레이션명 : 야드수냉재료 UPDATE parameter mapping
	 * 
