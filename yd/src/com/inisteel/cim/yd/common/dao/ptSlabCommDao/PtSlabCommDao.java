package com.inisteel.cim.yd.common.dao.ptSlabCommDao;
...
public class PtSlabCommDao {
	...
	private String szQueryIdUpd1 = "com.inisteel.cim.yd.common.dao.ptSlabCommDao.updPtSlabCommMatlFtmvDt";
	//update query id - 소재인수일시
	private String szQueryIdUpd2 = "com.inisteel.cim.yd.common.dao.ptSlabCommDao.updPtSlabCommMatlTkovDt";
	
	
	public int updPtSlabComm(JDTORecord inRec, int intGp) throws DAOException, JDTOException {

		String szMethodName         = "updPtSlabComm";
		int intRtnVal               = 0;
		Integer iRtn               	= null;
...
//	    	if(CHK.equals("Y")){
				...
				iRtn =(Integer)ejbConn.trx("updPtSlabCommReTX", new Class[] { JDTORecord.class, String.class }, new Object[] { inRec ,StringGp});
				if( iRtn.intValue() != YdConstant.RETN_INT_SUCCESS.intValue() ) {			//성공
					return intRtnVal = -1;
				}
//	    	}else{
//	    		//기존 방식 적용 
//	    		intRtnVal = this.updPtSlabCommTX(inRec, intGp);
//	    		if(intRtnVal ==0){
//	    			return intRtnVal = -1;
//	    		}
//	    	}
	 ...
	 * @throws DAOException
	 */
	public int updPtSlabCommTX(JDTORecord inRec, int intGp) throws DAOException {
		String szMethodName = "updPtSlabCommTX";
		String szMsg = null;
		int intRtnVal = 0;
