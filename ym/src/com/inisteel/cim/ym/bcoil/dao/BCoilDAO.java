 ...
 * 
 */
package com.inisteel.cim.ym.bcoil.dao;
...
public class BCoilDAO extends DBAssistantDAO {
	...
	public int jspSelect(JDTORecord inRec, JDTORecordSet outRecSet, String queryId, String logId, String mthdNm) throws DAOException, JDTOException {
		...
		String methodNm = "조회[BCoilDAO.jspSelect] < " + mthdNm;
		...
		try {
			...
			commUtils.printLog(logId, "조회[BCoilDAO.jspSelect] 결과 건수: " + rsTemp.size() , "DB");
	...
	public JDTORecordSet select(JDTORecord inRec, String queryId, String logId, String mthdNm, String trtNm) throws DAOException, JDTOException {
		...
		String methodNm = trtNm + "[BCoilDAO.select] < " + mthdNm;
		...
		try {
			...
			commUtils.printLog(logId, "조회[BCoilDAO.select] 결과 건수: " + rsTemp.size() , "DB");
	...
	public int update(JDTORecord inRec, String queryId, String logId, String mthdNm, String trtNm) throws DAOException, JDTOException {
		...
		String methodNm = trtNm + "[BCoilDAO.update] < " + mthdNm;
		...
		try {
			...
			commUtils.printLog(logId, trtNm + "[BCoilDAO.update] 결과 건수: " + intRtnVal , "DB");
	...
	public int insert(JDTORecord inRec, String queryId, String logId, String mthdNm, String trtNm) throws DAOException, JDTOException {
		...
		String methodNm = trtNm + "[BCoilDAO.insert] < " + mthdNm;
		...
		try {
			...
			commUtils.printLog(logId, trtNm + "[BCoilDAO.insert] 결과 건수: " + intRtnVal , "DB");
	...
	public int delete(JDTORecord inRec, String queryId, String logId, String mthdNm, String trtNm) throws DAOException, JDTOException {
		...
		String methodNm = trtNm + "[BCoilDAO.delete] < " + mthdNm;
		...
		try {
			...
			commUtils.printLog(logId, trtNm + "[BCoilDAO.delete] 결과 건수: " + intRtnVal , "DB");
